...
Si el jugador falla su salvación de CTR, entonces el investigador recibe estrés crítico y gana una consecuencia de la tabla de [Consecuencias del estrés](#tabla-de-consecuencias-del-estrés).
...
**ESTRÉS Y CONSECUENCIAS**
<br> El jugador elige de la Tabla [Consecuencias del estrés](Conscuencias-del-estrés) cuando:
